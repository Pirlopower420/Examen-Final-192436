...
public class AgenteManager {
    ...
    public void mostrarEstadisticasDeAgentes(){
        int numAgentes=agentes.size();
        System.out.println("total de agentes: "+numAgentes);
    }
    ...
    public void mostrarMenu() {
        ...
        while (continuar) {
            ...
            System.out.println("3. Cantidad de agentes ");
            ...
            switch (opcion) {
                ...
                case 3 -> mostrarEstadisticasDeAgentes();
