...
public class AnomaliaManager {
    ...
    public void mostrarEstadisticasDeAnomalias(){
        int numAnomalias=anomalias.size();
        System.out.println("total de anomalias: "+numAnomalias);
    }
    ...
    public void mostrarMenu() {
        ...
        while (continuar) {
            ...
            System.out.println("3. Cantidad de anomalias");
            ...
            switch (opcion) {
                ...
                case 3 -> mostrarEstadisticasDeAnomalias();
